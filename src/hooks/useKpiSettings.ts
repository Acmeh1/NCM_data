...
export const DEFAULT_KPI_OBJECTIVES: KpiObjective[] = [
  ...
  {
    id: "energy",
    label: "Ratio Énergie / Pièce",
    description: "Consommation de gaz (m³) rapportée au nombre de pièces cuites au four.",
    formula: "Gaz Total ÷ Nb Pièces",
    formulaLatex: "Ratio = \\frac{\\sum four\\_consommation\\_kwh}{\\sum nb\\_pieces\\_four}",
    unit: "m³/pc",
    objective: 0.05,
    objectiveLabel: "m³/pc maximum",
    lowerIsBetter: true,
    color: "rose",
  },
];
